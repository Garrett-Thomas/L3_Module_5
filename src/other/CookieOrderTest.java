...
public class CookieOrderTest {
	 ...
	 * 
	 * (d) When you are done, uncomment this test and run it to see if your class
	 * works.
	 */
	...
	/*
	 * 3. Add a method to MasterOrder that allows you to add a CookieOrder to it's
	 * List.
	 */
	// @Test
	 ...
	 * PART A
	 * 
	 * The getTotalBoxes method computes and returns the sum of the number of boxes
	 * of all cookie orders. If there are no cookie orders in the master order, the
	 * method returns 0.
	 */
	// @Test
	 ...
	 * PART B
	 * 
	 * The removeVariety method updates the master order by removing all of the
	 * cookie orders in which the variety of cookie matches the parameter cookieVar.
