...
public class FlightTest {
	...
	// Trip testTrip = new Trip();
	// Flight flight1 = new Flight(new Time("06/09/1978 09:00"), new
	// Time("06/09/1978 09:02"));
	// Flight flight2 = new Flight(new Time("06/09/1978 09:02"), new
	// Time("06/09/1978 10:30"));
	// testTrip.add(flight1);
	// testTrip.add(flight2);
	// assertEquals(90, testTrip.getDuration());
	// testTrip.clear();
	//
	// flight1 = new Flight(new Time("06/09/1978 18:00"), new Time("06/09/1978
	// 19:30"));
	// flight2 = new Flight(new Time("06/09/1978 19:30"), new Time("06/09/1978
	// 23:00"));
	// testTrip.add(flight1);
	// testTrip.add(flight2);
